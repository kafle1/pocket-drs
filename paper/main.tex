...
5~m, or whose fitted length is outside 1.5 to 25~m is rejected with a request to re-tap. The camera's end is inferred from which stump rectangle is larger in the image, and with the
...
velocity absorbs friction and turn.
...
\textbf{The estimator ignores drag, swing and spin.} The constant-velocity model absorbs them over short arcs
