...
$26.5$\,km/h) and bounce localization are markedly weaker and are reported as
...
Release-speed error (mean) & $26.5$\,km/h\\
\bottomrule
\end{tabular}
\end{table}

The bounce-point ($54.7$\,cm mean) and impact-point ($48.8$\,cm mean) errors are
much larger, and the release-speed error ($26.5$\,km/h mean) is large enough
...
$26.5$\,km/h on a near-axial view, PocketDRS should be understood to report
